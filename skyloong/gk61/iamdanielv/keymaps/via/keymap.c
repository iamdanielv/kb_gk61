...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_WIN] = LAYOUT_all(
        ...
        KC_LCTL,  KC_LGUI,  KC_LALT,             KC_SPC,   KC_SPC,     KC_MUTE,                KC_SPC,   KC_RALT,  LT(_WIN_INDEX, KC_LEFT),  TD(_DN_MU),               RCTL_T(KC_RIGHT)
    ),
     ...
     [_MAC] = LAYOUT_all(
        ...
        _______,  KC_LALT,  KC_LGUI,            _______,  _______,     _______,               _______,   KC_RGUI,  LT(_MAC_INDEX, KC_LEFT),   RALT_T(KC_DOWN),           RCTL_T(KC_RIGHT)
    ),
